...
However, if a faculty member has a complaint of harassment, discrimination, or other behaviors noted in [Middlebury’s Anti-harassment/Discrimination Policy](http://www.middlebury.edu/pages/i-policies-for-all/non-discrim-policies/anti-harassment-discrimin), the complaint procedure in that policy should be used.
...
Note that misconduct charges against a Middlebury Institute faculty member that fall under the Middlebury-wide [Non-Discrimination Policy](http://www.middlebury.edu/pages/i-policies-for-all/non-discrim-policies/b.1.a.non-discrimination-policy) are handled in accordance with those policies.
