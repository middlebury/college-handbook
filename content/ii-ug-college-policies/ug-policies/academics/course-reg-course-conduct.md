...
d. Courses taken under the Credit/No Credit option may not be used to satisfy major or minor requirements, with one exception: a first course taken under the Credit/No Credit option in a department or program in which a student subsequently declares a major or minor may, _with the approval of the department chair or program director_, be counted toward major or minor requirements.
