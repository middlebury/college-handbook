        ...
        <div className="row">
          ...
          <div className="col-lg-9">
            <ul className="midd-footer__list">
              ...
              <li className="midd-footer__item">
                <a href="https://www.middlebury.edu/emergency-response" className="midd-footer__link">
                  Emergency
                </a>
              </li>
              <li className="midd-footer__item">
                <a href="https://college-handbook.netlify.app/handbook/admin" className="midd-footer__link" rel="nofollow">
                  Site-Editor Login
                </a>
              </li>
            </ul>
